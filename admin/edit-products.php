...
$sql=mysqli_query($con,"update  products set category='$category',subCategory='$subcat',productName='$productname',productPrice='$productprice',productsize = '$productsize',productDescription='$productdescription',productAvailability='$productavailability' where id='$pid' ");
...
<div class="controls">
<input type="text"    name="productsize"  placeholder="Enter Product Price" value="<?php echo htmlentities($row['productsize']);?>"  class="span8 tip" required>
</div>
</div>
