...
$sql=mysqli_query($con,"insert into products(category,subCategory,productName,productprice, productsize, productDescription,productAvailability,productImage1,productImage2,productImage3) values('$category','$subcat','$productname','$productprice','$productsize','$productdescription','$productavailability','$productimage1','$productimage2','$productimage3')");
...
<div class="controls">
<input type="text"    name="productsize"  placeholder="Enter Product Price" class="span8 tip" required>
</div>
</div>
